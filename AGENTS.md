...
- Work on the `codex/feature` branch by default and keep `main` clean.
- Before committing repository changes, ensure the current branch is `codex/feature` unless the user explicitly asks for another branch.
